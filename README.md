...
# 0397springboot研究生调研管理系统pf

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T1bpekEK7?p=68)


# 第1章 绪论
## 1.1 课题背景
互联网发展至今，无论是其理论还是技术都已经成熟，而且它广泛参与在社会中的方方面面。它让信息都可以通过网络传播，搭配信息管理工具可以很好地为人们提供服务。所以各行业，尤其是规模较大的企业和学校等都开始借助互联网和软件工具管理信息，传播信息，共享信息等等，以此可以增强自身实力，提高在同行业当中的竞争能力，并从各种激烈的竞争中获取发展的机会。针对课表信息信息管理混乱，出错率高，信息安全性差，劳动强度大，费时费力等问题，经过分析和考虑，在目前的情况下，可以引进一款研究生调研管理系统这样的现代化管理工具，这个工具就是解决上述问题的最好的解决方案。它不仅可以实时完成信息处理，还缩短课表信息信息管理流程，使其系统化和规范化。同时还可以减少工作量，节约课表信息信息管理需要的人力和资金。所以研究生调研管理系统是信息管理环节中不可缺少的工具，它对管理者来说非常重要。
## 1.2 课题意义 
现如今，信息种类变得越来越多，信息的容量也变得越来越大，这就是信息时代的标志。近些年，计算机科学发展得也越来越快，而且软件开发技术也越来越成熟，因此，在生活中的各个领域，只要存在信息管理，几乎都有计算机的影子，可以说很多行业都采用计算机的方式管理信息。信息计算机化处理相比手工操作，有着保密性强，效率高，存储空间大，成本低等诸多优点。针对课表信息信息管理，采用研究生调研管理系统可以有效管理，使信息管理能够更加科学和规范。

总之，在实际中使用研究生调研管理系统，其意义如下：

第一点：研究生调研管理系统的实际运用，可以帮助管理人员在短时间内完成信息处理工作；
...
第四点：可以降低信息管理成本；
## 1.3 研究内容
对研究生调研管理系统设计制作，不仅需要技术支撑，也需要大量的理论研究。本文在对研究生调研管理系统进行介绍时，将按照如下内容进行。

第一部分：介绍研究生调研管理系统研究的背景意义，便于用户了解系统；

第二部分：介绍开发研究生调研管理系统需要搭建的环境，包括技术和工具；

第三部分：介绍用户对研究生调研管理系统的功能要求，以及对研究生调研管理系统的性能要求等；
...
# 第2章 开发环境与技术
研究生调研管理系统的编码实现需要搭建一定的环境和使用相应的技术，接下来的内容就是对研究生调研管理系统用到的技术和工具进行介绍。
## 2.1 MYSQL数据库
...
![C:/Users/Administrator/Desktop/temp111\2\img\情感树洞.jpg](/md/blog.006.jpeg "C:/Users/Administrator/Desktop/temp111\2\img\情感树洞.jpg")
情感树洞实体属性图

（2）下图是教师信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\教师信息.jpg](/md/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\2\img\教师信息.jpg")
教师信息实体属性图
...
![C:/Users/Administrator/Desktop/temp111\2\img\问卷表.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\2\img\问卷表.jpg")
问卷表实体属性图

（5）下图是问卷调查记录表实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\问卷调查记录表.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\2\img\问卷调查记录表.jpg")
问卷调查记录表实体属性图

（6）下图是答题详情表实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\答题详情表.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\2\img\答题详情表.jpg")
答题详情表实体属性图

（7）下图是课表信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\课表信息.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\2\img\课表信息.jpg")
课表信息实体属性图

（8）下图是公告信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\公告信息.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\2\img\公告信息.jpg")
公告信息实体属性图

（9）下图是专业信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\专业信息.jpg](/md/blog.014.jpeg "C:/Users/Administrator/Desktop/temp111\2\img\专业信息.jpg")
专业信息实体属性图

（10）下图是试题表实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\2\img\试题表.jpg](/md/blog.015.jpeg "C:/Users/Administrator/Desktop/temp111\2\img\试题表.jpg")
试题表实体属性图
...
|8|jiaoshi\_content|String|教师简介|是|
|9|jiaoshi\_delete|Integer|逻辑删除|是|
...
|5|jiaoshi\_id|Integer|上课教师|是|
|6|zhuanye\_id|Integer|专业信息|是|
|7|kecheng\_shangke|String|上课时间|是|
|8|kecheng\_shichang|String|课程时长|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|zhuanye\_name|String|专业名称|是|
|3|zuanye\_types|Integer|专业类型|是|
|4|zhuanye\_photo|String|专业封面|是|
|5|zhuanye\_shangke|String|师资力量|是|
|6|zhuanye\_number|Integer|招生人数|是|
|7|zhuanye\_types|Integer|学校|是|
|8|zhuanye\_erji\_types|Integer|学院|是|
|9|zhuanye\_content|String|专业简介|是|
|10|zhuanye\_delete|Integer|逻辑删除|是|
|11|insert\_time|Date|录入时间|是|
|12|create\_time|Date|创建时间|是|
表4.12管理员表
